...
public class SpawnerPanelMenu extends BaseMenu {
    ...
    public SpawnerPanelMenu(UltimateVirtualSpawner plugin, String worldName, int page) {
    ...
    public void handleClick(int slot, Player player, ClickType clickType) {
        ...
        if (destination.getWorld() == null) {
            plugin.getMessageManager().send(player, "SPAWNER.WORLD_NOT_LOADED");
            return;
        }
        ...
        plugin.getSpigotScheduler().teleport(player, destination).thenAccept(success ->
                plugin.getSpigotScheduler().runEntity(player, () -> {
                    ...
                    plugin.getMessageManager().send(player, "SPAWNER.TELEPORTED",
